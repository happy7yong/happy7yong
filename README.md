...
*" 동굴 속 죄수들은 오직 그림자만을 보고 그것을 현실이라고 믿는다. "*

우리는 아직 동굴 안에 머물러 있습니다.
<br>
</br>

이제는 **동굴 밖으로 나와 자신의 자만함을 마주하고,
스스로의 인생을 개척해야합니다.**

그런 당신이 인생을 개척해 앞으로 나아갈 때, 
...
|---|---|---|---|---|
| 25.09 ~ 25.11 | **⭐️ Core** | [mogi-logi](https://github.com/happy7yong/mogi_logi) | 작은 배움도 기록하고 남기는 개발자 로그 플랫폼 |  |
| 24.11 ~ 24.12 | **⭐️ Core** | [moodo](https://github.com/happy7yong/moodo) | 작성한 일기에 따라 꽃을 키우는 일기 App | |
| 25.03 ~ 25.11 | **⭐️ Core / Side** | [Abora-TeamTalk-LLM](https://github.com/happy7yong/Abora-TeamTalk-LLM) | IT 취준생을 위한 실시간 협업 커뮤니케이션 시뮬레이터  | 👑 |
| 25.03 ~ 25.11  | **🌸 Side** | GoodHands |  AI 감성 리포트로 시니어–보호자 간 정서적 소통을 지원하는 서비스 | 👑👑 |
| 24.03 ~ 24.11 | **🌸 Side** | [CoBal](https://github.com/happy7yong/CoBal) | AI 반려로봇 정서적 심리를 도와주는 소통 어플리케이션 | 👑👑👑  |
| 24.09 ~ 24.11 | **🌸 Side** | [HIP-Metaverse-LMS](https://github.com/happy7yong/HIP-Metaverse-LMS) | 메타버스 아카데미의 학생들의 통합 관리 웹 서비스 | |
| 25.12 | **🍁 Hackathon** | [pastlife-today](https://github.com/happy7yong/pastlife-today) | 전생 콘셉트의 4컷 이미지를 생성하는 웹앱 서비스 | |
| 24.03 ~ 24.06 | **🌱 Toy** | [recommand-major](https://github.com/happy7yong/recommand-major) | 홍익대학교 개발자의 전공 추천 웹 서비스 | |
| 24.10 ~ 24.12 | **Freelance** | [Induras](https://induras.kr/) | 차량 안전 관련 기업 소개용 반응형 웹사이트 | |
| ongoing | **🪶 Learning** | [TIL](https://github.com/happy7yong/RAN_TIL) | 개발 및 학습 과정 기록 |  |
...
| 2025.10 | 홍익대학교 **🎖️ 표창장** | | |
| 2025.11 | 2025년 2학기 **푸른등대 기부장학금 🎖️ 장학생** | | 한국장학재단, 세종 지역 1명 선발 |
